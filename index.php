...
<body id="body">
   ...
   <div class="header-box clear">		
        ...
        <table class="contentpaneopen">
          <tbody>
            <tr>
              ...
              <td width="332" colspan="2" valign="top"><h3><a href="http://news.bbc.co.uk/2/hi/south_asia/8638958.stm" onmousedown="return   clk(this.href,'news_result','','res','1','','0CDAQqQIwAA')">Indian Prime Minister <em>Narendra Modi</em> getting SIT summense</a></h3>
                Investigators have questioned the chief of the Indian Premier League   (IPL) over allegations of corruption linked to the lucrative cricket   tournament.
                <div> </div></td>
            </tr>
            <tr>
            ...
            <table class="contentpaneopen">
              <tbody>
                <tr>
                  ...
                  <td width="332" colspan="2" valign="top"><h3><a href="http://news.bbc.co.uk/2/hi/south_asia/8638958.stm" onmousedown="return   clk(this.href,'news_result','','res','1','','0CDAQqQIwAA')"><em>Hindu American group condemns killing of Hindus in Mayanmar</em></a></h3>
                   An eminent Hindu group in the US has expressed concern ove reports that a mass grave containing the bodies of 28 hindu.
                    <div>
    ...
    <div class="footer clear">
    	<span>Crime Reporting  &copy; 2017  |  <a href="#">Privacy Policy</a></span> Crime Reporting is for registering FIR any time and any where ever released . &nbsp;&nbsp;&nbsp;<!--{%FOOTER_LINK} -->
    </div>
</div>
